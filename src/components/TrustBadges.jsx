...
const badges = [
  ...
  },
  {
    icon: (
      <svg width="44" height="44" viewBox="0 0 24 24" fill="none">
        <path d="M7.5 12.5l3 3 6-6" stroke="#2D6B47" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"/>
        <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2z" stroke="#2D6B47" strokeWidth="2" fill="none"/>
      </svg>
    ),
    title: trustBadges.satisfaction.title,
  },
]
