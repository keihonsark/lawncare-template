...
const { city, state } = config.business
    ...
    <div className="rev__card">
      ...
      <div className="rev__author">
        ...
        <div>
          ...
          <span className="rev__author-source">Google Review &middot; {city}, {state}</span>
        </div>
      </div>
    </div>
  )
    ...
    <section id="reviews" className="rev fade-up">
      <div className="container">
        ...
        <div className="rev__google-badge">
          ...
          <span className="rev__google-score">{rating}</span>
          <span className="rev__google-stars">★★★★★</span>
          <span className="rev__google-count">{reviewCount} Google Reviews</span>
        </div>
      </div>
